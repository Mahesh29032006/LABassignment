  ...
  <body>
    ...
    <div class="container">
      <div class="component-section">
        ...
        <p>
          Select a component type to explore its properties, calculate values,
          and visualize the component with accurate specifications.
        </p>

        <div class="tab">
          <button class="tab-button active" data-tab="resistor">
            Resistor
          </button>
        ...
        <div class="tab-content active" id="resistor-tab">
          ...
          <p>
            Select colors for each band to calculate the resistor value and
            tolerance with real specifications.
          </p>
          ...
          <div class="component-controls">
            <div class="controls">
              <div class="control-group">
                ...
                <select id="band1">
                  ...
                  <option value="2" style="background-color: red; color: white">
                    Red - 2
                  </option>
                  <option
                    value="3"
                  ...
                  <option value="4" style="background-color: yellow">
                    Yellow - 4
                  </option>
                  <option
                    value="5"
                  ...
                  <option value="9" style="background-color: white">
                    White - 9
                  </option>
                </select>
              </div>
              ...
              <div class="control-group">
                ...
                <select id="band3">
                  ...
                  <option value="10000" style="background-color: yellow">
                    Yellow - ×10,000
                  </option>
                  <option
                    value="100000"
                  ...
                  <option value="0.01" style="background-color: silver">
                    Silver - ×0.01
                  </option>
                </select>
              </div>
              ...
              <div class="control-group">
                ...
                <select id="band4">
                  ...
                  <option value="10" style="background-color: silver">
                    Silver - ±10%
                  </option>
            ...
            <div class="visualization">
              ...
              <div class="result">
                <p>Resistor Value:</p>
                <p class="result-value" id="resistor-value">
          ...
          <div class="component-info">
            ...
            <p>
              Resistors are passive electrical components that create resistance
              in the flow of electric current. They are used to reduce current
              flow, adjust signal levels, divide voltages, and terminate
              transmission lines. The most common type is the carbon film
              resistor with power ratings from 0.125W to 5W.
            </p>
          </div>
        ...
        <div class="tab-content" id="capacitor-tab">
          ...
          <p>
            Calculate capacitor values based on the number code or select from
            common values with accurate specifications.
          </p>
          ...
          <div class="component-controls">
            ...
            <div class="visualization">
              ...
              <div class="result">
                <p>Capacitor Value:</p>
                <p class="result-value" id="capacitor-value">
          ...
          <div class="component-info">
            ...
            <p>
              Capacitors are passive electronic components that store electrical
              energy in an electric field. They consist of two conductive plates
              separated by a dielectric material. Common types include ceramic,
              electrolytic, film, and tantalum capacitors with capacitance
              values ranging from pF (picofarads) to mF (millifarads).
            </p>
          </div>
        ...
        <div class="tab-content" id="diode-tab">
          ...
          <p>
            Select a diode type to view its properties and specifications with
          ...
          <div class="component-info">
            ...
            <p>
              ...
              direction only. Common types include rectifier diodes (1N400x
              series), switching diodes (1N4148), Zener diodes (voltage
              regulation), and LEDs (light emission). Diodes have a forward
              voltage drop (0.3V for germanium, 0.7V for silicon) and a maximum
        ...
        <div class="tab-content" id="transistor-tab">
          ...
          <p>
            Select a transistor type to view its properties and pin
            configuration with accurate specifications.
          </p>
          ...
          <div class="component-controls">
            ...
            <div class="visualization">
              ...
              <div class="result">
                ...
                <p class="result-value" id="transistor-value">
          ...
          <div class="component-info">
            ...
            <p>
              ...
              electronic signals. Bipolar Junction Transistors (BJTs) come in
              two types: NPN and PNP. Key parameters include current gain (hFE),
              maximum collector current (IC), and maximum collector-emitter
              voltage (VCEO).
            </p>
          </div>
    ...
    <footer>
      <p>
        Electronic Components Explorer 2025 NIT,RKL | Based on Tech Lab
        Experiment 1 | All specifications are based on actual component
        datasheets
      </p>
    </footer>
    ...
    <script>
      ...
      document
        .getElementById("calculate-resistor")
        .addEventListener("click", calculateResistor);
      ...
      document
        .querySelectorAll("#band1, #band2, #band3, #band4")
        .forEach((select) => {
      ...
      function updateResistorVisualization() {
        ...
        document.getElementById("vis-band1").style.backgroundColor =
          getColorFromOption(band1);
        document.getElementById("vis-band2").style.backgroundColor =
          getColorFromOption(band2);
        document.getElementById("vis-band3").style.backgroundColor =
          getColorFromOption(band3);
        document.getElementById("vis-band4").style.backgroundColor =
          getColorFromOption(band4);
      }
      ...
      function calculateResistor() {
        ...
        document.getElementById(
          "resistor-value"
        ).textContent = `${displayValue} ±${band4}%`;
      }

      // Capacitor calculation functionality
      document
        .getElementById("calculate-capacitor")
        .addEventListener("click", calculateCapacitor);
      ...
      function calculateCapacitor() {
        ...
        if (code.length === 3 && !isNaN(code)) {
          ...
          document.getElementById(
            "capacitor-value"
          ).textContent = `${displayValue} ${unit}, ${voltage}V`;
          ...
          capElement.className =
            type === "electrolytic" || type === "tantalum"
          ...
          document.getElementById("capacitor-value").textContent =
            "Invalid code. Use 3 digits (e.g., 104 for 100nF)";
        }
      }

      // Diode functionality
      document
        .getElementById("show-diode-specs")
        .addEventListener("click", showDiodeSpecs);
      ...
      function showDiodeSpecs() {
        ...
        switch (diodeType) {
          case "1n4001":
            specs =
              "Type: General Purpose Rectifier | Max Forward Current: 1A | Peak Reverse Voltage: 50V | Forward Voltage: 0.7V | Package: DO-41";
            color = "black";
            break;
          case "1n4007":
            specs =
              "Type: General Purpose Rectifier | Max Forward Current: 1A | Peak Reverse Voltage: 1000V | Forward Voltage: 0.7V | Package: DO-41";
            color = "black";
            break;
          case "1n4148":
            specs =
              "Type: Fast Switching | Max Forward Current: 200mA | Peak Reverse Voltage: 75V | Forward Voltage: 0.7V | Reverse Recovery Time: 4ns | Package: DO-35";
            color = "black";
            break;
          case "1n5408":
            specs =
              "Type: Power Rectifier | Max Forward Current: 3A | Peak Reverse Voltage: 1000V | Forward Voltage: 0.7V | Package: DO-201AD";
            color = "black";
            break;
          case "zener5v":
            specs =
              "Type: Zener Voltage Regulator | Zener Voltage: 5.1V | Max Power: 1W | Forward Voltage: 0.7V | Tolerance: ±5% | Package: DO-41";
            color = "blue";
            isZener = true;
            break;
          case "zener12v":
            specs =
              "Type: Zener Voltage Regulator | Zener Voltage: 12V | Max Power: 1W | Forward Voltage: 0.7V | Tolerance: ±5% | Package: DO-41";
            color = "blue";
            isZener = true;
            break;
          case "led-red":
            specs =
              "Type: Light Emitting Diode | Color: Red | Forward Voltage: 1.8-2.2V | Max Current: 20mA | Wavelength: 620-625nm | Luminous Intensity: 20-40mcd";
            color = "red";
            isLED = true;
            break;
          case "led-green":
            specs =
              "Type: Light Emitting Diode | Color: Green | Forward Voltage: 2.0-2.4V | Max Current: 20mA | Wavelength: 515-530nm | Luminous Intensity: 30-60mcd";
            color = "green";
            isLED = true;
            break;
          case "led-blue":
            specs =
              "Type: Light Emitting Diode | Color: Blue | Forward Voltage: 3.0-3.4V | Max Current: 20mA | Wavelength: 460-470nm | Luminous Intensity: 20-40mcd";
            color = "blue";
            isLED = true;
            break;
          case "led-white":
            specs =
              "Type: Light Emitting Diode | Color: White | Forward Voltage: 3.0-3.4V | Max Current: 20mA | Color Temperature: 6000-8000K | Luminous Intensity: 30-50mcd";
            color = "white";
            isLED = true;
            break;
        }
      ...
      document
        .getElementById("show-transistor-specs")
        .addEventListener("click", showTransistorSpecs);
      ...
      function showTransistorSpecs() {
        ...
        switch (transistorType) {
          case "bc548":
            specs =
              "Type: NPN BJT | Max Collector Current: 100mA | Max VCEO: 30V | Current Gain (hFE): 110-800 | Max Power: 500mW | Package: TO-92";
            break;
          case "bc547":
            specs =
              "Type: NPN BJT | Max Collector Current: 100mA | Max VCEO: 45V | Current Gain (hFE): 110-800 | Max Power: 500mW | Package: TO-92";
            break;
          case "2n2222":
            specs =
              "Type: NPN BJT | Max Collector Current: 800mA | Max VCEO: 30V | Current Gain (hFE): 100-300 | Max Power: 500mW | Package: TO-18";
            break;
          case "bc557":
            specs =
              "Type: PNP BJT | Max Collector Current: 100mA | Max VCEO: 45V | Current Gain (hFE): 125-800 | Max Power: 500mW | Package: TO-92";
            break;
          case "2n3904":
            specs =
              "Type: NPN BJT | Max Collector Current: 200mA | Max VCEO: 40V | Current Gain (hFE): 100-300 | Max Power: 625mW | Package: TO-92";
            break;
          case "2n3906":
            specs =
              "Type: PNP BJT | Max Collector Current: 200mA | Max VCEO: 40V | Current Gain (hFE): 100-300 | Max Power: 625mW | Package: TO-92";
            break;
          case "tip31":
            specs =
              "Type: NPN Power BJT | Max Collector Current: 3A | Max VCEO: 40V | Current Gain (hFE): 10-50 | Max Power: 40W | Package: TO-220";
            break;
          case "tip32":
            specs =
              "Type: PNP Power BJT | Max Collector Current: 3A | Max VCEO: 40V | Current Gain (hFE): 10-50 | Max Power: 40W | Package: TO-220";
            break;
        }
